...
int x11_backend_start(void)
{
    ...
    for (int i = 0; i < num_entries; i++)
    {
        ...
        overlay[i] = XCreateWindow(d,                                                                // display
                                   root,                                                             // parent
                                   si[i].x_org + si[i].width - overlay_width - options.overlay_offset_right,   // x position
                                   si[i].y_org + si[i].height - overlay_height - options.overlay_offset_bottom, // y position
                                   overlay_width,                                                    // width
